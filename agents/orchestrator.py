...
class Orchestrator:
    ...
    def _generate_pr_body(self, state: AgentState) -> str:
        ...
        body_parts = [
            f"## 🤖 AI-Generated Fix for Issue #{state.issue_number}",
            "",
            f"**Issue:** {state.issue.title}",
            f"**Link:** {state.issue.url}",
            "",
            "## Summary",
            "",
            state.strategy or "Automated fix generated by RepoRepair AI agent.",
            "",
            "## Changes Made",
            "",
        ]
        ...
        body_parts.extend([
            ...
            "---",
            "",
            "⚠️ **IMPORTANT:** This is an AI-generated pull request. Please review carefully before merging.",
            "",
            f"Generated by [RepoRepair](https://github.com/tanishbhandari11t/Repo-Repair) made by Tanish",
        ])
